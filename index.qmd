...
::: {.subtitle}
If India redraws its parliamentary map by population, the states losing seats are the ones that cut their birth rates, schooled their daughters, and grew richer. The states gaining are the ones that did not. This is what the data shows.
:::
...
4. **It is not an artifact of the formula.** The South loses the same 26 seats under all four standard apportionment methods. The result is about demography, not arithmetic.
:::
...
<div class="stat-row">
  ...
  <div class="stat"><div class="stat-num">55</div><div class="stat-label">years since the<br>last reapportionment</div></div>
</div>
```
